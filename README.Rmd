...
The design rationale for the package can be found in the [About](./articles/about.html) article/vignette.


## Examples

Follow an example analysis in the [`hybcap`](./articles/hybcap.html) pipeline article/vignette.
